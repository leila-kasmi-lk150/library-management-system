            ...
            <section class="section">
                <div class="main">
                    <div class="sect">
                        ...
                        <?php
                        // get book borrow 
                        $query_run = mysqli_query($conn, "SELECT * FROM borrow,books WHERE borrow.idUser=$idUser AND borrow.idBook=books.idBook AND (nameBook LIKE '%$search%' OR isbn LIKE '%$search%' OR parallelTitele LIKE '%$search%')");
                        ...
                        <?php
                        // get book borrow 
                        $query_runGP = mysqli_query($conn, "SELECT * FROM borrow_gp,graduation_project WHERE borrow_gp.idUser=$idUser AND borrow_gp.idGP=graduation_project.idGP AND title LIKE '%$search%'");
