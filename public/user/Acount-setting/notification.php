            ...
            <div class="main">
                <div class="sect" id="accountSection">
                    ...
                    <div class="notification-msg">
                        <?php
                        $query=mysqli_query($conn,"SELECT * FROM notifications,books WHERE notifications.idBook=books.idBook AND notifications.idUser='$idUser' AND notifications.send='1'");
                        ...
                        ?>
                            ...
                            <p> <?php echo $row['nameBook']; echo " : "; echo $row['message'];?></p> 
                            <div class="noti" style="display: flex;">
                            <form action="delete.php" method="post">
                                <input type="hidden" name="idN" value="<?php echo $row['idN']; ?>">
                                <button type="submit" id="btn-N" class="delet-btn" name="deletN" onclick="return confirm('are you sure you want to delete ?')">Delete</button>
                            </form>
                             ...
                             <?php  $c++; }
                             $queryGP=mysqli_query($conn,"SELECT * FROM graduation_project,notifications_gp WHERE graduation_project.idGP=notifications_gp.idGP AND notifications_gp.idUser='$idUser' AND notifications_gp.send='1'");
                            // if(mysqli_num_rows($query) > 0)        
                            ...
                            ?>
                                ...
                                <i class="fa fa-bell"></i> <?php echo $c; ?> <br>
                                <p> <?php echo $row['title']; echo " : "; echo $row['message'];?></p> 
                                <div class="noti" style="display: flex;">
                                    <form action="delete.php" method="post">
                                        <input type="hidden" name="idN" value="<?php echo $row['idNGP']; ?>">
