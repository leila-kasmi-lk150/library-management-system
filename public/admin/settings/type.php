...
if (isset($_SESSION['idUser']) && $_SESSION['userType'] == 'admin') {
    ...
    <?php {
        ?>
        <div class="viewBook">
            <div class="typeName">Resource Types</div>
            ...
            <div style="display: flex;">
                ...
                <button id="add_book" name="add_book" type="submit" title="Add new"><i class="fa fa-plus"></i> <a
                        href="addType.php">Add new</a></button>
            </div>
            ...
            <div id="myTable">
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <?php
                    $sql = "SELECT * FROM typeBook,categorie WHERE categorie.idCategorie=typeBook.idCategorie";
                                    ...
                                    <center>
                                        <span style="width: 50%; background-color: transparent;" class="editSpan">
                                            <form action="edit.php" method="post">
                                                ...
                                                <button type="submit" name="editT" class="btn btn-edit"><i
