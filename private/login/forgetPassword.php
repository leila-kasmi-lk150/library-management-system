...
<body>
    ...
    <section class="main">
        <div class="login-container">
            <p class="title"><h1>Forgot Password</h1></p>
            <div class="separator"></div>
            <p class="welcome-message">Enter your email address</p>
            
            <form class="login-form" action="getCode.php" method="post" id="formValidation">
                ...
                <button type="submit" class="submit" name="submit">Continue</button>
            </form>
        </div>
    </section>
